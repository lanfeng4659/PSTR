...
from .synthtext_chinese_130k import SynthtextChinese130KDataset
from .lsvt import LSVTDataset
from .rects import ReCTSDataset
from .csvtr import CSVTRDataset
...
"SynthText90kDateset","SynthTextDataset","VeriSimilarDateset","SVTDataset","ArTDataset","IIITDataset","COCOTextDataset","RCTWDataset","CTWTrainDataset","CTWRetrievalDataset",
"ChineseCollectDataset",'SynthtextChinese130KDataset', 'LSVTDataset', 'ReCTSDataset', 'SynthText90kCropDateset','COCOTextAnnoDateset', 'CSVTRDataset']
